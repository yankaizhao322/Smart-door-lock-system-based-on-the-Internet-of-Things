...
#define  PRODUCTKEY           "a13sWoRCRgg"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "A001"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                                   //设备名长度
#define  DEVICESECRE          "a3966fb77ae35de35d3492af872b1d34"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a13sWoRCRgg/A001/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a13sWoRCRgg/A001/thing/event/property/post"    //需要发布的主题        
